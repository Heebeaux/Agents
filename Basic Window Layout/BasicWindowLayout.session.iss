objectdef bwlSession
{
    ...
    method ApplyWindowLayout()
    {
        ...
        WindowCharacteristics -pos -viewable 1920,0 -size -viewable ${mainWidth}x${mainHeight} -frame none

        variable uint numSmallRegion
        variable uint useX=1920
    ...
    {
        if ${SwapOnActivate}
            SwapOnActivate:Set[FALSE]
        else
            SwapOnActivate:Set[TRUE]
    }
}
